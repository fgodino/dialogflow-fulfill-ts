declare module 'dialogflow-fulfill-ts' {
    ...
    export class Context {
      public get(name: string): ContextObject;
      public set(name: string | ContextObject, lifespan?: number, parameters?: object): void;
    ...
    export class WebhookClient {
       ...
       */
      public getContext(contextName: string): ContextObject;
